...
public sealed class DemoDataStore
{
    ...
    private void SeedNotifications()
    {
        ...
        Notifications.AddRange([
            // ── Specialist: Sarah Chen (user-spec-1) ─────────────────────────
            new Notification { ID=NextNotifId(), UserID="user-spec-1", PaRequestID=1,  Message="PA-2026-00001 for Dorothy Harrington has been Approved. Authorization AUTH-20260420-00001 issued.",      NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-5),  ReadAt=now.AddDays(-4) },
            new Notification { ID=NextNotifId(), UserID="user-spec-1", PaRequestID=2,  Message="PA-2026-00002 for Gerald Fontaine has been Denied. Reason: Step therapy requirements not met.",          NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-6),  ReadAt=now.AddDays(-5) },
            new Notification { ID=NextNotifId(), UserID="user-spec-1", PaRequestID=4,  Message="PA-2026-00004 for Thomas Bradfield has been submitted and is awaiting reviewer assignment.",              NotificationType=NotificationType.StatusChanged,     IsRead=true,  CreatedAt=now.AddDays(-2),  ReadAt=now.AddDays(-2) },
            new Notification { ID=NextNotifId(), UserID="user-spec-1", PaRequestID=9,  Message="PA-2026-00009 for Constance Bloom has been Approved. Authorization AUTH-20260428-00003 issued.",         NotificationType=NotificationType.DecisionRendered,  IsRead=false, CreatedAt=now.AddDays(-2) },
            new Notification { ID=NextNotifId(), UserID="user-spec-1", PaRequestID=10, Message="PA-2026-00010 for Nathan Cole is overdue — decision was due 6 days ago. Please follow up.",              NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-spec-1", PaRequestID=11, Message="PA-2026-00011 for Patricia Morse is now Under Review. Decision due in 2 days.",                          NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-spec-1", PaRequestID=14, Message="PA-2026-00014 for Leah Tran has been Denied. Reason: Psychotherapy benefit exhausted for plan year.",   NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-16), ReadAt=now.AddDays(-15) },

            // ── Specialist: Marcus Webb (user-spec-2) ────────────────────────
            new Notification { ID=NextNotifId(), UserID="user-spec-2", PaRequestID=3,  Message="PA-2026-00003 for Miriam Okafor: reviewer requested additional clinical documentation.",                 NotificationType=NotificationType.StatusChanged,     IsRead=true,  CreatedAt=now.AddDays(-3),  ReadAt=now.AddDays(-3) },
            new Notification { ID=NextNotifId(), UserID="user-spec-2", PaRequestID=5,  Message="PA-2026-00005 for Angela Rossi is Pending Info — please provide neurology consult note and headache diary.", NotificationType=NotificationType.StatusChanged, IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-spec-2", PaRequestID=7,  Message="PA-2026-00007 for Frances Delacroix has been Denied. Appeal window is open for 30 days.",               NotificationType=NotificationType.AppealWindow,      IsRead=true,  CreatedAt=now.AddDays(-17), ReadAt=now.AddDays(-16) },
            new Notification { ID=NextNotifId(), UserID="user-spec-2", PaRequestID=7,  Message="PA-2026-00007 appeal for Frances Delacroix has been submitted and is under review.",                     NotificationType=NotificationType.StatusChanged,     IsRead=true,  CreatedAt=now.AddDays(-10), ReadAt=now.AddDays(-9) },
            new Notification { ID=NextNotifId(), UserID="user-spec-2", PaRequestID=12, Message="PA-2026-00012 for Sylvia Hayward: authorization AUTH-20260309-00004 expires in 7 days.",                 NotificationType=NotificationType.ExpirationAlert,   IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-spec-2", PaRequestID=15, Message="PA-2026-00015 for Walter Grimes (Emergent) submitted — decision required within 24 hours.",              NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-3) },

            // ── Provider: Dr. Elena Vasquez (user-prov-1) ────────────────────
            new Notification { ID=NextNotifId(), UserID="user-prov-1", PaRequestID=1,  Message="Authorization AUTH-20260420-00001 approved for Dorothy Harrington. Valid through " + now.AddDays(100).ToString("MMM d, yyyy") + ".",  NotificationType=NotificationType.DecisionRendered, IsRead=true,  CreatedAt=now.AddDays(-5),  ReadAt=now.AddDays(-4) },
            new Notification { ID=NextNotifId(), UserID="user-prov-1", PaRequestID=3,  Message="PA-2026-00003 for Miriam Okafor is now Under Review. Please ensure all clinical notes are uploaded.",    NotificationType=NotificationType.StatusChanged,     IsRead=true,  CreatedAt=now.AddDays(-4),  ReadAt=now.AddDays(-3) },
            new Notification { ID=NextNotifId(), UserID="user-prov-1", PaRequestID=7,  Message="PA-2026-00007 for Frances Delacroix — appeal is now under review by the payer.",                         NotificationType=NotificationType.StatusChanged,     IsRead=true,  CreatedAt=now.AddDays(-10), ReadAt=now.AddDays(-9) },
            new Notification { ID=NextNotifId(), UserID="user-prov-1", PaRequestID=8,  Message="Authorization AUTH-20260207-00002 for Harold Simmons has expired. A new PA must be submitted.",          NotificationType=NotificationType.ExpirationAlert,   IsRead=false, CreatedAt=now.AddDays(-17) },
            new Notification { ID=NextNotifId(), UserID="user-prov-1", PaRequestID=12, Message="Authorization AUTH-20260309-00004 for Sylvia Hayward expires in 7 days. Procedure should be scheduled.", NotificationType=NotificationType.ExpirationAlert,   IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-prov-1", PaRequestID=15, Message="PA-2026-00015 for Walter Grimes is pending payer review. Emergent case — expected 24-hour turnaround.",  NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-3) },

            // ── Provider: Dr. James Kim (user-prov-2) ────────────────────────
            new Notification { ID=NextNotifId(), UserID="user-prov-2", PaRequestID=5,  Message="PA-2026-00005 for Angela Rossi is Pending Info. Additional documentation required before review.",       NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-prov-2", PaRequestID=9,  Message="Authorization AUTH-20260428-00003 approved for Constance Bloom. 3 ESI sessions authorized.",             NotificationType=NotificationType.DecisionRendered,  IsRead=false, CreatedAt=now.AddDays(-2) },
            new Notification { ID=NextNotifId(), UserID="user-prov-2", PaRequestID=11, Message="PA-2026-00011 for Patricia Morse is now Under Review. Estimated decision by " + now.AddDays(1).ToString("MMM d") + ".", NotificationType=NotificationType.StatusChanged, IsRead=true, CreatedAt=now.AddDays(-5), ReadAt=now.AddDays(-5) },

            // ── Provider: Dr. Aisha Patel (user-prov-3) ──────────────────────
            new Notification { ID=NextNotifId(), UserID="user-prov-3", PaRequestID=4,  Message="PA-2026-00004 for Thomas Bradfield is under specialist review. Decision due " + now.AddDays(1).ToString("MMM d") + ".", NotificationType=NotificationType.StatusChanged, IsRead=true, CreatedAt=now.AddDays(-2), ReadAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-prov-3", PaRequestID=10, Message="PA-2026-00010 for Nathan Cole has been pending a decision for 20 days and is overdue.",                  NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-prov-3", PaRequestID=14, Message="PA-2026-00014 for Leah Tran has been Denied. Reason: Psychotherapy benefit exhausted.",                 NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-16), ReadAt=now.AddDays(-15) },

            // ── Reviewer: Robert Torres (user-rev-1) ─────────────────────────
            new Notification { ID=NextNotifId(), UserID="user-rev-1",  PaRequestID=3,  Message="PA-2026-00003 for Miriam Okafor (Urgent) has been in review for 4 days — decision overdue.",             NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-rev-1",  PaRequestID=4,  Message="PA-2026-00004 for Thomas Bradfield (Urgent) assigned for review. Decision due " + now.AddDays(1).ToString("MMM d") + ".", NotificationType=NotificationType.StatusChanged, IsRead=false, CreatedAt=now.AddDays(-2) },
            new Notification { ID=NextNotifId(), UserID="user-rev-1",  PaRequestID=5,  Message="PA-2026-00005 for Angela Rossi (Emergent) is awaiting additional info before review can proceed.",       NotificationType=NotificationType.StatusChanged,     IsRead=true,  CreatedAt=now.AddDays(-1),  ReadAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-rev-1",  PaRequestID=7,  Message="PA-2026-00007 appeal for Frances Delacroix received. Review required within 30 days.",                   NotificationType=NotificationType.AppealWindow,      IsRead=true,  CreatedAt=now.AddDays(-10), ReadAt=now.AddDays(-9) },
            new Notification { ID=NextNotifId(), UserID="user-rev-1",  PaRequestID=10, Message="PA-2026-00010 for Nathan Cole (Routine) is 6 days overdue. Immediate review required.",                  NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-rev-1",  PaRequestID=11, Message="PA-2026-00011 for Patricia Morse (Urgent) assigned for review. Decision due 2 days ago.",                NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-2) },
            new Notification { ID=NextNotifId(), UserID="user-rev-1",  PaRequestID=15, Message="PA-2026-00015 for Walter Grimes (Emergent) requires immediate review — 24-hour SLA active.",             NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-3) },

            // ── Billing Manager: Linda Park (user-bill-1) ────────────────────
            new Notification { ID=NextNotifId(), UserID="user-bill-1", PaRequestID=8,  Message="Authorization AUTH-20260207-00002 for Harold Simmons has expired. Claims may be denied if procedure proceeds.", NotificationType=NotificationType.ExpirationAlert, IsRead=false, CreatedAt=now.AddDays(-17) },
            new Notification { ID=NextNotifId(), UserID="user-bill-1", PaRequestID=12, Message="Authorization AUTH-20260309-00004 for Sylvia Hayward expires in 7 days. Confirm scheduling.",             NotificationType=NotificationType.ExpirationAlert,   IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-bill-1", PaRequestID=1,  Message="PA-2026-00001 approved — AUTH-20260420-00001 issued for Dorothy Harrington. Billing may proceed.",        NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-5),  ReadAt=now.AddDays(-4) },
            new Notification { ID=NextNotifId(), UserID="user-bill-1", PaRequestID=9,  Message="PA-2026-00009 approved — AUTH-20260428-00003 issued for Constance Bloom. 3 units authorized.",            NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-2),  ReadAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-bill-1", PaRequestID=2,  Message="PA-2026-00002 for Gerald Fontaine has been Denied. No billing authorization — do not submit claim.",      NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-6),  ReadAt=now.AddDays(-5) },
            new Notification { ID=NextNotifId(), UserID="user-bill-1", PaRequestID=14, Message="PA-2026-00014 for Leah Tran has been Denied. No authorization issued — claim will be rejected.",          NotificationType=NotificationType.DecisionRendered,  IsRead=true,  CreatedAt=now.AddDays(-16), ReadAt=now.AddDays(-15) },

            // ── Admin (user-admin-1) ──────────────────────────────────────────
            new Notification { ID=NextNotifId(), UserID="user-admin-1", PaRequestID=null, Message="3 authorization records are expiring within the next 7 days. Review the expiration report.",           NotificationType=NotificationType.ExpirationAlert,   IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-admin-1", PaRequestID=null, Message="System: 2 PA requests have exceeded their SLA decision deadline and require escalation.",              NotificationType=NotificationType.StatusChanged,     IsRead=false, CreatedAt=now.AddDays(-1) },
            new Notification { ID=NextNotifId(), UserID="user-admin-1", PaRequestID=7,    Message="PA-2026-00007 appeal for Frances Delacroix has been active for 10 days — escalation threshold reached.", NotificationType=NotificationType.AppealWindow,    IsRead=true,  CreatedAt=now.AddDays(-10), ReadAt=now.AddDays(-9) },
        ]);
    }
